...
class SchoolsAdapter: RecyclerView.Adapter<SchoolsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(val item = schoolSet[position]) {
            is ViewType.SCHOOL -> {
                (holder as SchoolsViewHolder).schoolBinding(item.schoolItem, onClickedSchool)
            }
            is ViewType.LETTER -> {
...
class SchoolsViewHolder() : RecyclerView.ViewHolder()
